...
export const currentRoleFocus: RoleFocusData = {
  id: "playon-sports",
  ...
  logoSrc: "/logos/playonsports.com.svg",
  logoAlt: "PlayOn Sports",
  stats: [
  ...
  pillars: [
    {
      ...
      details: (
        <>
          ...
          <p>
            Converted a second Rails service the same way three weeks later, rolling it out behind a
            weighted CloudFront traffic split I built myself — a reusable tool to ramp, pause, and
