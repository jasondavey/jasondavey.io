...
import { Box, Typography, Container, Card, CardContent, useTheme, alpha } from "@mui/material";
      ...
      <Container sx={{ position: "relative", zIndex: 1 }}>
        ...
        <Box sx={{ textAlign: "center", mb: 10 }}>
          ...
          >
            ...
            >
              My approach to leadership combines technical expertise with a focus on people
              development, creating environments where innovation thrives and teams excel.
            </Typography>
          </motion.div>
        </Box>
