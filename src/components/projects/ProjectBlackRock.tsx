...
const ProjectBlackRock: Project = {
  ...
  businessView: (
    <>
      <p className="mb-2">
        <strong>Problem:</strong> BlackRock faced substantial unnecessary software licensing costs due to unused or underutilized applications on corporate desktops, with no automated way to track and manage these licenses.
      </p>
      <p className="mb-2">
        <strong>Purpose:</strong> To implement an automated license control system that could identify and manage application installations, tracking usage patterns and automatically uninstalling applications that exceeded business thresholds for inactivity.
      </p>
      <p className="mb-2">
        <strong>Business Solution:</strong> Developed a sophisticated software license control system that automatically tracked application usage and reclaimed licenses for unused software, resulting in thousands of dollars in cost savings across corporate desktops.
      </p>
    </>
  ),
  ...
  description: (
    <>
      ...
      <p className="mb-2">
        Beyond this project, as Technical Lead, I initiated and led a comprehensive review and overhaul of the Software Development Life Cycle (SDLC) process, resulting in the successful renewal of standards and processes in July 2009. I also architected and led engineering teams in implementing various web-based, globally distributed systems.
      </p>
      <p className="mb-2">
        <strong>Role:</strong> As Technical Lead, I drove architectural design based on object-oriented principles and patterns modeling, managed the in-house applications framework ("commons"), and ensured engineering quality through disciplined approaches to best practices including unit testing, code quality control, automated deployment, continuous integration, and UI testing.
      </p>
    </>
  ),
  image: "",
  ...
  details: (
    <>
      ...
      <ul className="list-disc ml-6 text-700 mb-2">
        <li>
          Designed and implemented automated software license tracking and management system
        </li>
        <li>
          Led comprehensive SDLC process overhaul, resulting in renewed standards
        </li>
        <li>
          Architected globally distributed web-based systems
        </li>
        <li>
          Implemented best practices for code quality including unit testing, code reviews, and automated testing
        </li>
        <li>
        ...
        <li>
          Served as active member of the GSS architecture and SOA teams
        </li>
      </ul>
    </>
  ),
