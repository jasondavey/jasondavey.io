...
import { SiVite, SiTailwindcss, SiShadcnui, SiVercel, SiAmazonroute53 } from "react-icons/si";
...
const stack = [
  ...
  { name: "AWS Route53", icon: <SiAmazonroute53 className="text-orange-500" /> },
];
    ...
    <section id="stack" className="py-16 bg-white dark:bg-black border-b">
      <div className="section-container text-center">
        ...
        <p className="text-engineering-gray mb-8 max-w-2xl mx-auto">
          This project is built with a modern stack for speed, scalability, and great developer experience.
        </p>
      ...
      <p className="mt-8 text-xs text-engineering-gray">
        Deployed on <span className="font-semibold">Vercel</span>. Domain managed with <span className="font-semibold">AWS Route53</span>.
      </p>
      </div>
    </section>
  );
